...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Shift" },            "Print", function () os.execute("gnome-screenshot -w") end),
    awful.key({ modkey  },            "Print", function () os.execute("gnome-screenshot -a") end),
...
-- {{{ Only have borders when not filling whole thing
for s = 1, screen.count() do
